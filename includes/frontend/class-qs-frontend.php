		...
		wp_localize_script(
			...
			array(
				...
				'i18n'      => array(
					...
					'name'          => __('Name', 'quickslot'),
					'email'         => __('Email', 'quickslot'),
					'phone'         => __('Phone', 'quickslot'),
					'note'          => __('Note', 'quickslot'),
					'confirmBooking' => __('Confirm Booking', 'quickslot'),
					'reviewBooking'  => __('Review Booking', 'quickslot'),
					...
					'dateLabel'         => __('Date', 'quickslot'),
					'timeLabel'         => __('Time', 'quickslot'),
					'bookingIdLabel'    => __('Booking ID', 'quickslot'),
					'fieldNameRequired'  => __('Please enter your name.', 'quickslot'),
					'fieldEmailRequired' => __('Please enter your email address.', 'quickslot'),
					'fieldEmailInvalid'  => __('Please enter a valid email address.', 'quickslot'),
					'monthNames'    => array(
